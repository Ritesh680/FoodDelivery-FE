...
- __Application__ refers to Meat Delivery, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to meat-delivery.
...
- __Website__ refers to meat-delivery, accessible from [http://localhost:5173](http://localhost:5173)
