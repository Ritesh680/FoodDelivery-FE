	...
	return (
		<div>
			...
			<ul>
				...
				<li>
					<p>
						<strong>Application</strong> refers to Meat Delivery, the software
				...
				<li>
					<p>
						...
						this Agreement) refers to meat-delivery.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Website</strong> refers to meat-delivery, accessible from{" "}
						<a
			...
			<ul>
				<li>By email: ritesh@gmail.com</li>
			</ul>
		</div>
	);
};
